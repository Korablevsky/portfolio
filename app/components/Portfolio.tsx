...
export default function Portfolio() {
  ...
  const projects = [
    {
      title: "Coffee Shop",
      description: "Веб приложение для продажи кофе, можно фильтровать по странам и сортам, делать поиск. (desktop / mobile)",
      image: "/portfolio/coffee.png",
      details: "Используется Next js (App Router), typeScript, FSD, Zustand, Tailwind CSS",
      technologies: ["Next js (App Router)", "typeScript", "FSD", "Zustand", "Tailwind CSS"],
      github: "https://github.com/Korablevsky",
      live: "https://coffee-alpha-one.vercel.app/"
    },
    {
      title: "RMT-development",
      description: "Веб приложение по поиску разработчиков (desktop). Настроена фильтрация, добавление в избранное, удаление из избранного",
    ...
    {
      title: "Marvel App",
      description: "Приложение для любителей Marvel, можно узнать больше о персонажах и их историях",
      image: "/portfolio/marvel.png",
      details: "Создано с помощью React и React Beautiful DnD для плавного перетаскивания задач.",
    ...
    {
      title: "Ruby Home",
      description: "Прилодение для продажи квартир. Фунционал убран, так как это демо версия (desktop / mobile)",
    ...
    {
      title: "Dental Clinic",
      description: "Сложное веб приложение для клиники, можно записаться на прием, перенести на другой день, удалить запись и так далее (desktop)",
          ...
          >
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[625px]">
                ...
                <img src={project.image} alt={project.title} className="w-full h-auto object-cover rounded-md mb-4" />
                <div className="flex justify-between">
                  <a href={project.github} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-purple-600 transition-colors">
                    <GithubIcon className="mr-2" /> GitHub
                  </a>
                  <a href={project.live} target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-purple-600 transition-colors">
